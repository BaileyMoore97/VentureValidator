      ...
      <Card className="h-fit bg-white/80 backdrop-blur-sm border-gray-200">
        ...
        <CardContent>
          <div className="text-center py-12 text-gray-500">
            ...
            <p className="text-sm">Start adding items from the categories on the left</p>
          </div>
        </CardContent>
      </Card>
    );
      ...
      <CardHeader className="pb-4">
        <div className="flex items-center justify-between">
          <CardTitle className="flex items-center gap-2">
            ...
            Your {getFrequencyText()} Shopping List
          </CardTitle>
          <Button
            variant="outline"
            size="sm"
        ...
        <div className="flex items-center gap-4 text-sm text-gray-600">
          ...
          <span>For {numberOfPeople} {numberOfPeople === 1 ? 'person' : 'people'}</span>
          {completedCount > 0 && (
            <>
